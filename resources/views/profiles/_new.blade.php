...
<div class="form-group">
    ...
    {!! Form::text('no_gaji', null, ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Contoh : 4132']) !!}
</div>

<div class="form-group">
    <label for="nama">*Nama</label>
    {!! Form::text('nama', null, ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Contoh : Muhammad bin Abdullah']) !!}
</div>

<div class="form-group">
    <label for="nokp">*No KP</label>
    {!! Form::text('nokp', null, ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Contoh : 850130025567']) !!}
</div>
...
<div class="form-group">
    ...
    {!! Form::text('email', null, ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Contoh : email@example.com']) !!}
</div>

<div class="form-group">
    <label for="alamat1">Alamat 1</label>
    {!! Form::text('alamat1', null, ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Contoh : IBU PEJABAT MADA']) !!}
</div>

<div class="form-group">
    <label for="alamat2">Alamat 2</label>
    {!! Form::text('alamat2', null, ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Contoh : AMPANG JAJAR, ALOR SETAR']) !!}
</div>
...
<div class="form-group">
    ...
    {!! Form::text('jawatan', null, ['class' => 'form-control', 'autocomplete' => 'off', 'placeholder' => 'Contoh: Pegawai Pertanian ']) !!}
</div>
