    ...
    <div class="row">
        <div class="col-xs-6">
            <div class="panel panel-primary">
                <div class="panel-heading"><h4>Tayar / Bateri</h4></div>
                <div class="panel-body">

                    <form method="post" action="{{ route('members.tayar.proses') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="jumlah" max="2000" id="jumlah" step="any" placeholder="Contoh : RM 1000.00" onkeyup="calc()" />
                        </div>
